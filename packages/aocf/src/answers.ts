...
Answers.register('blacha', 2015, 16, 40, 241);
Answers.register('blacha', 2015, 17, 1304, 18);
...
Answers.register('blacha', 2020, 15, 1194, 48710);
Answers.register('blacha', 2020, 16, 24980, 809376774329);
Answers.register('blacha', 2020, 17, 267, 1812);
Answers.register('blacha', 2020, 18, 800602729153, 92173009047076);
Answers.register('blacha', 2020, 19, 235, 379);
Answers.register('blacha', 2020, 20, 8425574315321, 1841);
Answers.register('blacha', 2020, 21, 1679, 'lmxt,rggkbpj,mxf,gpxmf,nmtzlj,dlkxsxg,fvqg,dxzq');
Answers.register('blacha', 2020, 22, 35397, 31120);
Answers.register('blacha', 2020, 23, 98742365, 294320513093);
Answers.register('blacha', 2020, 24, 287, 3636);
Answers.register('blacha', 2020, 25, 18433997, -1);
